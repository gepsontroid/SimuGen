...
namespace Mockooo.Services
{
    ...
    /// </summary>
    public class ExporterCSVSTV : Exporter
    {
        public ExporterCSVSTV(DataTable dtExport) : base(dtExport)
        {
        }
    ...
    public class ExportXML : Exporter
    {
        ...
        public string ExportToXML(string fileName = "mockdata.xml")
        {
            ...
            MemoryStream streamDataExporter = new MemoryStream();
            _dtExport.WriteXml(streamDataExporter, true);
            streamDataExporter.Seek(0, SeekOrigin.Begin);
            StreamReader streamReader = new StreamReader(streamDataExporter);
            string xml = streamReader.ReadToEnd();
            streamDataExporter.Close();
            streamReader.Close();
